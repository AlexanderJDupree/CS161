...
namespace Custom
{
    ...
    public:
        ...
        void getSortedValues(int ara[], const int SIZE, int& counter);
    ...
    void sortArray(int ara[], const int VALUE_MAX, const int SIZE, int& counter);
